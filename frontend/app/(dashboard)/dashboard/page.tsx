  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-1">Monday Night Football · Season {currentYear}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          <h2 className="font-semibold text-gray-900 mb-4">⭐ All time longest unbeaten streak</h2>
          <div className="flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-50">
            <h2 className="font-semibold text-gray-900">Season {currentYear} top performers</h2>
          </div>
              ...
              <div className="px-5 py-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-black text-amber-500">
                    {mostPlayed.matchesPlayed} played
                  </span>
                </div>
              </div>
            ) : null;
